...
US_income_averages_18 <- 
   read_excel("../data/TabFig2018prel.xlsx", 
              ...
              col_names = FALSE,
              col_types = "numeric")
# v_names <- read.xlsx("./data/TabFig2018prel.xlsx", sheetName = "Table A3", startRow = 4, endRow = 4, colIndex = c(2:7, 9:14), colClasses = character, header = FALSE)
