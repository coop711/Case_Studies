---
title: "BFI, MI Report : Case Studies 1902"
author: "coop711"
date: "`r Sys.Date()`"
...
(MI_ok_id <- setdiff(1:nrow(MI), MI_na_id))
...
setequal(MI_sort_full_kr$ID, BFI$ID)
#> 이름은 제외
...
```{r, save, echo = FALSE}
save.image("BFI_MI_report_CS1902.RData")
```