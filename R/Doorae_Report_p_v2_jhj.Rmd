...
m5 <- m4 + 
  ...
  ggtitle("공동체상태와 조직형태")
m6 <- m5 + 
  theme(title = element_text(family = ""),
...
##Comments
관광 사업에서 경영과 창업준비, 법인과 임의단체로 나누어 분석하여 여러가지 조건에서 수치를 table과 모자이크로 확인 할 수 있었다. 그리고 또한 표적분포함수(ECDF)를 통해서도 다양한 모양으로 바꾸며 비교를 할 수 있었다.