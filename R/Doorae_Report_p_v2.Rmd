...
m5 <- m4 + 
  ...
  ggtitle("공동체상태와 조직형태")
m6 <- m5 + 
  theme(title = element_text(family = "KoPubWorldDotum Medium"),
...
```{r, echo = FALSE, fig.width = 6, fig.height = 4.2, message = FALSE}
source("./mosaic_gg_old_v2.R")
tbl %>%
...
```{r, echo=FALSE, fig.width = 6, fig.height = 4.5, message = FALSE}
doorae %$%
