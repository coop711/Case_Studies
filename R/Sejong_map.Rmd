...
library(broom) #> `tidy()`
library(extrafont) #> "Malgun Gothic"
options(width = 132)
```
...
p_S <- pointLabel(Lon_S, Lat_S, Names_S, offset = 0, cex = 0.5, family = "Malgun Gothic")
p_N <- pointLabel(Lon_N, Lat_N, Names_N, offset = 0, cex = 0.5, family = "Malgun Gothic")
```
...
par(mar = c(0, 0, 3.1, 0), mfrow = c(1, 2), oma = c(0, 0, 2, 0), family = "Malgun Gothic")
...
```{r, fig.width = 12, fig.height = 12}
par(mar = c(0, 0, 3.1, 0), family = "Malgun Gothic")
...
```{r, fig.width = 12, fig.height = 12}
par(mar = c(0, 0, 0, 0), mfrow  = c(2, 2), family = "Malgun Gothic")
cols_b <- rates_b * 10
cols_b
cols_c <- rates_c * 10
cols_c
...
par(mar = c(0, 0, 3.1, 0), mfrow = c(1, 3), oma = c(0, 0, 2, 0), family = "Malgun Gothic")
...
```{r, fig.width = 12, fig.height = 12}
par(mar = c(0, 0, 3.1, 0), mfrow = c(1, 2), family = "Malgun Gothic")
...
# par(mar = c(0, 0, 0, 0), family = "Malgun Gothic")
...
```{r, fig.width = 12, fig.height = 12}
par(mar = c(3.1, 0, 3.1, 0), family = "Malgun Gothic")
