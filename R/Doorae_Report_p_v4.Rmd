...
m1 + theme_bw(base_family = "KoPubWorldDotum Medium") +
  geom_text(aes(x = center, y = 1.05),
            label = tbl_p_df[, 2],
            family = "KoPubWorldDotum Medium") + 
  labs(title = "공동체상태와 조직형태", x = "공동체상태", y = "조직형태") +
...
m3 +
  ...
  geom_text(aes(x = center, y = 1.05),
            label = p_df3[, 2],
            family = "KoPubWorldDotum Medium") + 
  labs(title = "공동체상태와 조직유형", x = "공동체상태", y = "조직유형") +
...
m4 +
  ...
  geom_text(aes(x = center, y = 1.05),
            label = p_df4[, 2],
            family = "KoPubWorldDotum Medium") + 
  labs(title = "공동체상태와 사업아이템", x = "공동체상태", y = "사업아이템") + 
  scale_fill_brewer(name = "사업아이템", type = "div") +
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18,
                                  family = "KoPubWorldDotum Bold"))
```
