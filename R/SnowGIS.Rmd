...
library(ggmap)
#> source = "dsk" server is down.
# John_Snow_code <- geocode("John Snow, London, England", source = "dsk")
#> Google Maps => "John Snow, London" => "이곳이 궁금한가요?" => c(lat = , lon = ) (순서에 유의)
John_Snow_code <- c(lon = -0.136560, lat = 51.513368)
m <- get_map(John_Snow_code, 
             zoom = 17, 
             source = "google",
             maptype = "roadmap")
#> mdsr 텍스트에서 bbox 좌표 추출
...
ggsave(file = "../pics/Snow.png", device = "png", dpi = 160)
