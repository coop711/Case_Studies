...
doorae %$%
  ...
  mosaic_gg(base_family = "Malgun Gothic",
            ...
            ylab = "조직형태", 
            fill_name = "공동체상태") +
  scale_fill_brewer(name = "공동체상태", type = "qual")
```
...
doorae %$%
  ...
  mosaic_gg(base_family = "Malgun Gothic",
            ...
            ylab = "공동체상태",
            fill_name = "조직형태") +
  scale_fill_brewer(name = "조직형태", type = "div")
```
...
box_2 <- box_1 + 
  ...
  xlab("공동체상태") + 
  ylab("업력(년)") +
  theme(plot.title = element_text(family = "Malgun Gothic"),
        axis.text.x = element_text(family = "Malgun Gothic"),
        axis.title.x = element_text(family = "Malgun Gothic"),
        axis.title.y = element_text(family = "Malgun Gothic"))
# box_2
box_3 <- box_2 + 
...
# ecdf_3
ecdf_4 <- ecdf_3 + 
  theme(panel.background=element_rect("white"), panel.border=element_rect(colour="black", fill = NA))
# ecdf_4
ecdf_5 <- ecdf_3 + 
  ggtitle("공동체상태와 업력") +
  xlab("업력(년)") +
  ...
  theme(plot.title = element_text(family = "Malgun Gothic"),
        axis.title.x = element_text(family = "Malgun Gothic"),
        axis.title.y = element_text(family = "Malgun Gothic"),
        legend.title = element_text(family = "Malgun Gothic"),
        legend.text = element_text(family = "Malgun Gothic"))
# ecdf_5
ecdf_8 <- ecdf_5 + 
  labs(colour = "공동체상태") 
# ecdf_8
...
poly_6 <- poly_5 + 
  xlab("업력(년)") +
  theme(axis.title.x = element_text(family = "Malgun Gothic"))
# poly_6
poly_7 <- poly_6 + 
  ylab("분위") +
  theme(axis.title.y = element_text(family = "Malgun Gothic"))
# poly_7
poly_8 <- poly_7 + 
  labs(colour = "공동체상태") 
# poly_8
