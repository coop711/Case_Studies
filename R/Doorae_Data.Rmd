...
#> trim.ws = TRUE 의 효과는 read.xlsx 를 그대로 돌리는 것과 같은 효과
doorae0924.rest <- read_excel("../data/Data0924.xlsx", sheet = 1, range = "B1:BB98", trim_ws = FALSE)
doorae0924.name <- read_excel("../data/Data0924.xlsx", sheet = 1, range = "A1:A98")
...
years.in.business <- round(as.numeric(difftime("2015-09-24", doorae0924$"설립일", units = "days")) / 365, digits = 1)
