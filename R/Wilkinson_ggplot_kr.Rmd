...
options(width = 132)
load("Inequality_Index_HS_v2.RData")
dim(data_full)
...
p1_1
p1_2 <- p1_1 + 
  geom_text(family = "KoPubWorldDotum Light")
p1_2
p2 <- p1_1 + 
  theme_bw() 
p2
...
```{r, fig.width = 8, fig.height = 6}
main_title_2 <- "GDP와 건강 및 사회문제 지수"
x_lab_2 <- "GDP(달러)"
y_lab_2 <- "건강 및 사회문제 지수"
gd5 <- gd4 + 
...
gd6 <- gd5 + 
  annotate("text", 
           x = 40000, 
           y = 2, 
           label = paste("상관계수 =", round(cor_2, digits = 2)), 
           size = 5,
           family = "KoPubWorldDotum Medium")
# gd6
gd7 <- gd6 +
